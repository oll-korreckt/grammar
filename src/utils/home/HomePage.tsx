...
export const HomePage: React.VFC = () => {
    return (
        <div className={accessClassName(styles, "container")}>
            ...
            <p>Checking preview. Am I supposed to use <i>I</i> or <i>me</i>? When do I have to use <i>well</i> instead of <i>good</i>? Do I need to use a comma here or can I leave it alone?</p>
