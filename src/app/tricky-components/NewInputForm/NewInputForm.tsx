...
export interface NewInputFormProps {
    initialValue?: string;
...
// function getCursorPosition(errKey: string): [number, number] {
...
export const NewInputForm: React.FC<NewInputFormProps> = ({ initialValue, onStateChange }) => {
...
const ExtendedTextEditor = withClassName(NewTextEditor, accessClassName(styles, "extendedTextEditor"));
